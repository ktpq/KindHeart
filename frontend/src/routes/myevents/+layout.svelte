...
<main class="bg-[#f0f4ff] min-h-screen p-5">
    <section class="w-[90%] mx-auto mt-5 max-lg:w-[100%]">
        ...
        <!-- Page Header -->
        <h1 class="text-[48px] font-bold text-center text-blue-900 mb-2">My Events</h1>
        <p class="text-blue-700 text-center text-lg mb-10">All the events you’ve created and are currently managing.</p>
