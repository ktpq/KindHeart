...
<main class="bg-[#FEF5ED] h-screen flex justify-center items-center">
  <section class="grid grid-cols-2 w-[65vw] max-xl:w-full max-xl:grid-cols-1">
    ...
    <!-- เอาไว้ใส่ภาพ -->
    <div class="max-xl:hidden" data-aos="fade-right" data-aos-duration="1500">
      <img src="./register/image.png" alt="">
    </div>
    <!-- register section -->
    <div class="px-25 flex flex-col items-center justify-center max-lg:px-15 max-sm:px-5"  data-aos="fade-left" data-aos-duration="1500">
      <h1 class="text-5xl font-semibold mb-5 text-center">Register</h1>
