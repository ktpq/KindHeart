...
<div class="bg-[#aec2a9]/10 p-7 my-5 shadow-md rounded-xl border border-[#aec2a9] hover:shadow-lg hover:-translate-y-1 duration-200 cursor-pointer">
    ...
    <p class="ml-13 mt-2 text-gray-500"> {noti.created_at_display} </p>
