<script lang="ts">
    ...
    try {
        ...
        // ส่ง request
        const response = await axios.post(`${base_api}/api/event/`, formData, {
...
<div class="grid grid-cols-3 gap-10 mt-5 max-md:grid-cols-1 max-md:gap-3">
    ...
    <div>
        ...
        <input type="text" class="w-full mt-3 px-5 py-3 rounded-xl focus:outline-none bg-[#D3E4CD]" placeholder="Enter your event capacity" bind:value={max_capacity}>
    </div>
</div>
...
<div class="flex items-center justify-between mt-10">
    ...
    <div class="flex items-center space-x-4">
        ...
        <button class="shadow-md px-6 py-3 cursor-pointer rounded-lg shadow-md text-white bg-[#32b04f] hover:bg-[#22923c] duration-200" onclick={handleSubmit}>Create</button>
    </div>
</div>